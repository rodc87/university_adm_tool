...
<li class="dropdown">
  ...
  <ul class="dropdown-menu" role="menu" style="width:100%;">
  <li><a href="{{ url('/examens') }}"><i class="glyphicon glyphicon-menu-right"></i>Examens</a></li>
  <li><a href="{{ url('/calendrierExamens') }}"><i class="glyphicon glyphicon-menu-right"></i>Calendrier d'examens</a></li>
  <li><a href="{{ url('/inscritsExamens') }}"><i class="glyphicon glyphicon-menu-right"></i>Inscrits aux Examens</a></li>
  <li><a href="{{ url('/consultationNotesExamens') }}"><i class="glyphicon glyphicon-menu-right"></i>Consultation de Notes</a></li>
  <li><a href="{{ url('/copiesExamens') }}"><i class="glyphicon glyphicon-menu-right"></i>Copies d'Examen</a></li>
  </ul>
</li>
</ul>

...
<a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-th-list padding-right-small" style="position:relative;top: 3px;"></span>
  ...
  <ul class="dropdown-menu" role="menu" style="width:100%;">
          ...
          <li><a href="{{ url('/choixModules') }}"><i class="glyphicon glyphicon-menu-right"></i>Choix de Modules</a></li>
          <li><a href="{{ url('/historiqueChoixModules') }}"><i class="glyphicon glyphicon-menu-right"></i>Historique des Choixs</a></li>
  </ul>
</li>
</ul>
<ul class="nav navbar-nav">
<li class="dropdown">
  ...
  <li><a href="{{ url('/inscriptionExamens') }}"><i class="glyphicon glyphicon-menu-right"></i>Inscription</a></li>

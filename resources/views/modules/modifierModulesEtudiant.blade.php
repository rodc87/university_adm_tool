...
<div class="content">
  ...
  <h4><strong>Modules Ouverts</strong></h4>
            <div class="well">
                <div>
                    <div>
                ...
                @if(count($modouverts)>0)
                    @foreach ($modouverts as $mods)
                        <li class="list-group-item alert-warning">{{ $mods->code_module }}</li>
                    @endforeach
                @endif
                </ul>
            </div>
        ...
        <div class="dual-list list-right col-md-5">
            <h4><strong>Modules Choisis</strong></h4>
            <div class="well">
                <div>
                    <div>
                        <div class="input-group">
                ...
                @if(count($choixs)>0)
                    @foreach ($choixs as $choix)
                        <li class="list-group-item alert-warning">{{ $choix->code_module }}</li>
                    @endforeach
                @endif
                </ul>
            </div>
  ...
  <div class="dual-list col-md-10">
    ...
    <a href="{{ url('/choixModules') }}" class="btn btn-danger btn-md"><i class="glyphicon glyphicon-arrow-left"></i>Annuler</a>
    {!! Form::open(array('id'=>'form_choix','action' => 'ChoixModulesEtudiantController@modifierpost', 'class' =>'login-form')) !!}

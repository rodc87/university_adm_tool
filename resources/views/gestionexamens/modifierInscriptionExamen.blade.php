...
<div class="content">
        <div class="header">
            <h1 class="page-title">Modifier choix d'examens</h1>
                    <ul class="breadcrumb">
            <li><a href="{{ url('/')}}">Accueil</a> </li>
            <li class="active">Examens</li>
            <li class="active">Inscription Examens</li>
            <li class="active">Modifier choix d'examens</li>
        </ul>
        </div>
  <div>
{!! Form::open(array('id'=>'formid','action' => 'GestionExamensController@postmodifierInscriptionExamen', 'class' =>'login-form')) !!}
  @if (count($centres) > 0)
  <div class="col-lg-12">
      <h4><strong>Veuillez choisir votre centre de passage d'examens: </strong></h4>
      @if($autre_centre == 1)
      {!! Form::select('centre',$centres," ",['id'=>'centre','class' => 'form-control','required']) !!}
      @else
      {!! Form::select('centre',$centres,$centre,['id'=>'centre','class' => 'form-control','required']) !!}
      @endif
  </div>
  @if($autre_centre == 1)
  <div id="autre_centre_div" class="col-lg-12">
    <h4><strong>Veuillez préciser le nom de cet autre centre de passage d'examens :</strong></h4>
    <input id="autre_centre" type="text" name="autre_centre" value="{{$centre}}" class="form-control" required/>
 </div>
 @else
   <div id="autre_centre_div" class="col-lg-12" style="display:none;">
     <h4><strong>Veuillez préciser le nom du centre de passage d'examens :</strong></h4>

...
<div class="content">
        <div class="header">
            <h1 class="page-title">Modifier Delais d'Inscription</h1>
                    <ul class="breadcrumb">
            <li><a href="{{ url('/')}}">Accueil</a> </li>
            <li class="active">Gestion des Examens</li>
            <li class="active">Delais d'Inscription</li>
            <li class="active">Modifier Delais d'Inscription</li>
        </ul>
        </div>
        <div class="main-content">

        {!! Form::open(array('action' => 'GestionExamensController@postModifierExamensDelaisInscription','id' => 'formid','enctype'=>'multipart/form-data')) !!}
        <div class="col-md-6 alert alert-info">
             <div class="form-group">
               @if (count($allsemestres) > 0)
               <label  class="form-label"><strong>Semestre:</strong></label>
               {!! Form::select('semestre',$allsemestres,$semestre,['class' => 'form-control form-inline']) !!}
               @endif
            </div>
        <div class="control-group">
           <div class="controls">
               ...
               <div class="input-group">
                   <input id="date_debut" name="date_debut" type="text" class="date-picker form-control" value="{{$date_debut}}" required/>
        ...
        <div class="controls">
            ...
            <div class="input-group">
                <input id="date_fin" name="date_fin" type="text" class="date-picker form-control" value="{{$date_fin}}" required/>

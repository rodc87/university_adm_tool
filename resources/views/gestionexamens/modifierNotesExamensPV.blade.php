...
<div class="content">
        <div class="header">
            <h1 class="page-title">Attribuer ou Modifier Note d'Examen après PV</h1>
                    <ul class="breadcrumb">
            <li><a href="{{ url('/')}}">Accueil</a> </li>
            <li class="active">Examens</li>
            <li class="active">Consultation de Notes</li>
            <li class="active">Attribuer ou Modifier Note d'Examen après PV</li>
        </ul>
        </div>
        <div class="main-content">
        {!! Form::open(array('action' => 'GestionExamensController@postmodifierNotesExamensPV','id' => 'formid','enctype'=>'multipart/form-data')) !!}
        ...
        <div class="form-group">
          ...
          <label for="spinner" class="form-label" ><strong>Attribuer ou Modifer note d'examen après PV:</strong></label></br>

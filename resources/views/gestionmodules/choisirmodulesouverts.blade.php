...
<div class="content">
        <div class="header">
            <h1 class="page-title">Choisir Liste de Modules Ouverts</h1>
                    <ul class="breadcrumb">
            <li><a href="{{ url('/')}}">Accueil</a> </li>
            <li class="active">Gestion de Modules</li>
            <li class="active">Modules Ouverts</li>
            <li class="active">Choisir Liste de Modules Ouverts</li>
        </ul>
        </div>
  <div>
  ...
  <div class="dual-list col-md-10">
    ...
    {!! Form::open(array('id'=>'form_choix','action' => 'GestionModulesController@postchoisirmodulesouverts', 'class' =>'login-form')) !!}
